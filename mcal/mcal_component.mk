...
ifeq ($(PLATFORM),$(filter $(PLATFORM), am263))
mcal_mcal_EXAMPLE_LIST = mcu_app gpt_app mcspi_app can_app port_app dio_app wdg_app fls_app eth_app eth_test_app adc_app pwm_app icu_app ipc_notify_app ipc_rpmsg_app ipc_rpmsg_callback_app i2c_app uart_echo_dma_app fsirx_app lin_app flsdiag_app epwm_app epwm_tz_app dma_interruptmode_app dma_linkingmode_app dma_pollingmode_app dma_chainingmode_app cdd_cmpss_app
...
ifeq ($(PLATFORM),$(filter $(PLATFORM), am263px))
mcal_mcal_EXAMPLE_LIST = mcu_app gpt_app mcspi_app can_app port_app dio_app wdg_app adc_app adc_resolver_app adc_hw_trig_dma_app eth_app eth_test_app pwm_app icu_app ipc_notify_app ipc_rpmsg_app ipc_rpmsg_callback_app i2c_app uart_echo_dma_app fsirx_app lin_app dma_interruptmode_app dma_linkingmode_app dma_pollingmode_app dma_chainingmode_app fls_app flsdiag_ospi_app epwm_app epwm_tz_app cdd_flc_app cdd_cmpss_app
mcal_mcal_APP_LIB_LIST += app_utils
