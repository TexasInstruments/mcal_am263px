...
CONST(Cdd_I2c_ConfigType, CDD_I2C_CONFIG_DATA)
CddI2cInitParams = {
    .CddI2cHwCfgPtr =
        {
            [0] =
...
CONST(Cdd_I2c_ConfigPtrType, CDD_I2C_CONFIG_DATA)
pCddI2cInitParams = (Cdd_I2c_ConfigType *)&CddI2cInitParams;

VAR(Cdd_I2c_Channel_Config, CDD_I2C_CONFIG_DATA)
Cdd_I2cChannelContainer[CDD_I2C_MAXIMUM_CHANNEL_NUMBER] = {
    [0] =
        {
            .Dir                = CDD_I2C_READ,
            .SlaveAddress       = 34U,
...
CONST(Cdd_I2c_Sequence_Config, CDD_I2C_CONFIG_DATA)
Cdd_I2cSequenceContainer[CDD_I2C_MAXIMUM_SEQUENCE_NUMBER] = {
    [0] =
        {
            .HwInstance             = CDD_I2C_HW_UNIT_2,
            .MaxChannels            = 1U,
            ...
            .ChannelList =
                {
                    /* The Number Of Channels generated below are equal to the variable
