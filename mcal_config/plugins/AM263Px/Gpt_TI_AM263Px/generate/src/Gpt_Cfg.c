...
[!ELSEIF "$Id <= '19'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule4CounterBlk0Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSEIF "$Id <= '23'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule5CounterBlk0Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSEIF "$Id <= '27'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule6CounterBlk0Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSE!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule7CounterBlk0Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ENDIF!][!//
[!ELSE!][!//
[!IF "$Id <= '3'"!][!//
...
[!ELSEIF "$Id <= '19'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule4CounterBlk1Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSEIF "$Id <= '23'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule5CounterBlk1Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSEIF "$Id <= '27'"!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule6CounterBlk1Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ELSE!][!//
[!WS "8"!].GptChannelTickFrequency = [!" as:modconf('Gpt')[1]/GptDriverConfiguration/GptModule7CounterBlk1Frequency"!]U,  /* Pre-scalar value to be set */[!//
[!ENDIF!][!//
[!ENDIF!]
