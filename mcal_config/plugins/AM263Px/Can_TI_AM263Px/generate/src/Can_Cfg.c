    ...
    [!"../../@name"!]_PC_[!"@name"!] =
{
    ...
    [!IF "(num:i($CanControllerIdIndx)) >= '8'"!][!ERROR "Number of controllers supported is 8 only"!][!ENDIF!]
    ...
    [!ENDIF!]
    [!ENDIF!]
	[!IF "CanControllerBaseAddress = '1382285312'"!]
    ...
    [!ENDIF!]
    [!ENDIF!]
	[!IF "CanControllerBaseAddress = '1382350848'"!]
    ...
    [!ENDIF!]
    [!ENDIF!]
	[!IF "CanControllerBaseAddress = '1382416384'"!]
    ...
    [!ENDIF!]
    [!ENDIF!]
	[!IF "CanControllerBaseAddress = '1382481920'"!]
...
[!VAR "MCAN4TxCnt" = "0"!] [!VAR "MCAN4RxCnt" = "0"!] [!VAR "MCAN4TxFifoCnt" = "0"!] [!VAR "MCAN4RxFifoCnt" = "0"!]
[!VAR "MCAN5TxCnt" = "0"!] [!VAR "MCAN5RxCnt" = "0"!] [!VAR "MCAN5TxFifoCnt" = "0"!] [!VAR "MCAN5RxFifoCnt" = "0"!]
[!VAR "MCAN6TxCnt" = "0"!] [!VAR "MCAN6RxCnt" = "0"!] [!VAR "MCAN6TxFifoCnt" = "0"!] [!VAR "MCAN6RxFifoCnt" = "0"!]
[!VAR "MCAN7TxCnt" = "0"!] [!VAR "MCAN7RxCnt" = "0"!] [!VAR "MCAN7TxFifoCnt" = "0"!] [!VAR "MCAN7RxFifoCnt" = "0"!]
...
[!VAR "MCAN4StdFilterCnt" = "0"!] [!VAR "MCAN4ExtdFilterCnt" = "0"!]
[!VAR "MCAN5StdFilterCnt" = "0"!] [!VAR "MCAN5ExtdFilterCnt" = "0"!]
[!VAR "MCAN6StdFilterCnt" = "0"!] [!VAR "MCAN6ExtdFilterCnt" = "0"!]
[!VAR "MCAN7StdFilterCnt" = "0"!] [!VAR "MCAN7ExtdFilterCnt" = "0"!]
    ...
    [!"../../@name"!]_[!"@name"!] =
{
    ...
    [!IF "CanObjectType = 'TRANSMIT'"!][!//
    [!VAR "MCAN4TxCnt" = "node:value(CanHwObjectCount) + $MCAN4TxCnt"!][!//
    [!"num:i($MCANTxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCANTxCnt" = "$MCANTxCnt + 1"!][!//
    [!IF "num:i($MCAN4TxCnt) > '32'"!][!ERROR "Number of Transmit mailboxes supported is 32 only"!][!ENDIF!][!//
    [!ELSEIF "node:value(CanHwObjectCount) = '1'"!][!//
    [!"num:i($MCAN4RxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCAN4RxCnt" = "$MCAN4RxCnt+1"!][!//
    [!IF "(num:i($MCAN4RxCnt)) > '64'"!][!ERROR "Number of Receive mailboxes supported is 64 only"!][!ENDIF!][!//
    [!ELSE!][!//
    [!VAR "MCAN4RxFifoCnt" = "$MCAN4RxFifoCnt + node:value(CanHwObjectCount)"!][!//
    [!IF "(num:i($MCAN4RxFifoCnt)) > '64'"!][!ERROR "Number of Receive FiFo mailboxes supported is 64 only"!][!ENDIF!][!//
    0U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "'MCAN5' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!][!//
    [!IF "CanObjectType = 'TRANSMIT'"!][!//
    [!VAR "MCAN5TxCnt" = "node:value(CanHwObjectCount) + $MCAN5TxCnt"!][!//
    [!"num:i($MCANTxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCANTxCnt" = "$MCANTxCnt + 1"!][!//
    [!IF "num:i($MCAN5TxCnt) > '32'"!][!ERROR "Number of Transmit mailboxes supported is 32 only"!][!ENDIF!][!//
    [!ELSEIF "node:value(CanHwObjectCount) = '1'"!][!//
    [!"num:i($MCAN5RxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCAN5RxCnt" = "$MCAN5RxCnt+1"!][!//
    [!IF "(num:i($MCAN5RxCnt)) > '64'"!][!ERROR "Number of Receive mailboxes supported is 64 only"!][!ENDIF!][!//
    [!ELSE!][!//
    [!VAR "MCAN5RxFifoCnt" = "$MCAN5RxFifoCnt + node:value(CanHwObjectCount)"!][!//
    [!IF "(num:i($MCAN5RxFifoCnt)) > '64'"!][!ERROR "Number of Receive FiFo mailboxes supported is 64 only"!][!ENDIF!][!//
    0U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "'MCAN6' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!][!//
    [!IF "CanObjectType = 'TRANSMIT'"!][!//
    [!VAR "MCAN6TxCnt" = "node:value(CanHwObjectCount) + $MCAN6TxCnt"!][!//
    [!"num:i($MCANTxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCANTxCnt" = "$MCANTxCnt + 1"!][!//
    [!IF "num:i($MCAN6TxCnt) > '32'"!][!ERROR "Number of Transmit mailboxes supported is 32 only"!][!ENDIF!][!//
    [!ELSEIF "node:value(CanHwObjectCount) = '1'"!][!//
    [!"num:i($MCAN6RxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCAN6RxCnt" = "$MCAN6RxCnt+1"!][!//
    [!IF "(num:i($MCAN6RxCnt)) > '64'"!][!ERROR "Number of Receive mailboxes supported is 64 only"!][!ENDIF!][!//
    [!ELSE!][!//
    [!VAR "MCAN6RxFifoCnt" = "$MCAN6RxFifoCnt + node:value(CanHwObjectCount)"!][!//
    [!IF "(num:i($MCAN6RxFifoCnt)) > '64'"!][!ERROR "Number of Receive FiFo mailboxes supported is 64 only"!][!ENDIF!][!//
    0U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!ENDIF!][!//
    [!ENDIF!][!//
    [!IF "'MCAN7' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!][!//
    [!IF "CanObjectType = 'TRANSMIT'"!][!//
    [!VAR "MCAN7TxCnt" = "node:value(CanHwObjectCount) + $MCAN7TxCnt"!][!//
    [!"num:i($MCANTxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCANTxCnt" = "$MCANTxCnt + 1"!][!//
    [!IF "num:i($MCAN7TxCnt) > '32'"!][!ERROR "Number of Transmit mailboxes supported is 32 only"!][!ENDIF!][!//
    [!ELSEIF "node:value(CanHwObjectCount) = '1'"!][!//
    [!"num:i($MCAN7RxCnt)"!]U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!VAR "MCAN7RxCnt" = "$MCAN7RxCnt+1"!][!//
    [!IF "(num:i($MCAN7RxCnt)) > '64'"!][!ERROR "Number of Receive mailboxes supported is 64 only"!][!ENDIF!][!//
    [!ELSE!][!//
    [!VAR "MCAN7RxFifoCnt" = "$MCAN7RxFifoCnt + node:value(CanHwObjectCount)"!][!//
    [!IF "(num:i($MCAN7RxFifoCnt)) > '64'"!][!ERROR "Number of Receive FiFo mailboxes supported is 64 only"!][!ENDIF!][!//
    0U,  /* HwHandle i.e Mailbox - Hw object in the controller */
    [!ENDIF!][!//
    [!ENDIF!][!//
    ...
    [!IF "CanIdType = 'EXTENDED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN4ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN4ExtdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'STANDARD' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN4StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN4StdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'MIXED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN4StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN4StdFilterCnt)"!]
    [!VAR "MCAN4ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN4ExtdFilterCnt)"!]
    [!ENDIF!]
    [!IF "(num:i($MCAN4StdFilterCnt)) > '128'"!][!ERROR "Number of Standard ID Filter elements supported is 128 only"!][!ENDIF!]
    [!IF "(num:i($MCAN4ExtdFilterCnt)) > '64'"!][!ERROR "Number of Extended ID Filter elements supported is 64 only"!][!ENDIF!]
    [!ELSEIF "'MCAN5' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!]
    [!IF "CanIdType = 'EXTENDED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN5ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN5ExtdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'STANDARD' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN5StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN5StdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'MIXED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN5StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN5StdFilterCnt)"!]
    [!VAR "MCAN5ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN5ExtdFilterCnt)"!]
    [!ENDIF!]
    [!IF "(num:i($MCAN5StdFilterCnt)) > '128'"!][!ERROR "Number of Standard ID Filter elements supported is 128 only"!][!ENDIF!]
    [!IF "(num:i($MCAN5ExtdFilterCnt)) > '64'"!][!ERROR "Number of Extended ID Filter elements supported is 64 only"!][!ENDIF!]
    [!ELSEIF "'MCAN6' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!]
    [!IF "CanIdType = 'EXTENDED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN6ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN6ExtdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'STANDARD' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN6StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN6StdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'MIXED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN6StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN6StdFilterCnt)"!]
    [!VAR "MCAN6ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN6ExtdFilterCnt)"!]
    [!ENDIF!]
    [!IF "(num:i($MCAN6StdFilterCnt)) > '128'"!][!ERROR "Number of Standard ID Filter elements supported is 128 only"!][!ENDIF!]
    [!IF "(num:i($MCAN6ExtdFilterCnt)) > '64'"!][!ERROR "Number of Extended ID Filter elements supported is 64 only"!][!ENDIF!]
    [!ELSEIF "'MCAN7' = node:value(node:ref(node:current()/CanControllerRef)/CanControllerInstance)"!]
    [!IF "CanIdType = 'EXTENDED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN7ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN7ExtdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'STANDARD' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN7StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN7StdFilterCnt)"!]
    [!ELSEIF "CanIdType = 'MIXED' and CanObjectType = 'RECEIVE'"!]
    [!VAR "MCAN7StdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN7StdFilterCnt)"!]
    [!VAR "MCAN7ExtdFilterCnt" = "num:i($HwFilterCnt) + num:i($MCAN7ExtdFilterCnt)"!]
    [!ENDIF!]
    [!IF "(num:i($MCAN7StdFilterCnt)) > '128'"!][!ERROR "Number of Standard ID Filter elements supported is 128 only"!][!ENDIF!]
    [!IF "(num:i($MCAN7ExtdFilterCnt)) > '64'"!][!ERROR "Number of Extended ID Filter elements supported is 64 only"!][!ENDIF!]
    [!ENDIF!]
